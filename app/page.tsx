      ...
      <div className="bg-white rounded-2xl shadow-2xl p-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1
            ...
            style={{ color: "#064e3b" }}
          >
            Navneet Public Sr. Sec. School
          </h1>
          <p className="text-sm mt-1" style={{ color: "#059669" }}>
            CBSE Affiliated — School Management System
          </p>
        </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border-2 outline-none text-sm focus:ring-2 focus:ring-green-600"
          ...
          <button
            ...
            style={{
              background: loading
                ? "#9ca3af"
                : "linear-gradient(90deg,#059669,#064e3b)",
        ...
        <div className="mt-6 grid grid-cols-3 gap-3">
          {[
            ...
            <div
              ...
              className="text-center p-3 rounded-xl cursor-pointer hover:scale-105 transition"
              style={{
                background: "#f0fdf4",
